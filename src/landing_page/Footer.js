        ...
        <div className='container border-top mt-5' >
            <div className='row mt-5'>
                ...
                <div className='col list-style'>
                    <p>Accounts</p>
                        <div className='py-3'>
                        <a href=""  className='text-muted mb-5' style={{textDecoration:"none"}}>Open demat account</a><br/>
                    <a href=""  className='text-muted mb-5' style={{textDecoration:"none"}}>Minor demat account</a><br/>
                    <a href=""  className='text-muted mb-5' style={{textDecoration:"none"}}>NRI demat account</a><br/>
                    <a href=""  className='text-muted py-5' style={{textDecoration:"none"}}>Commodity</a><br/>
                    <a href=""  className='text-muted py-5' style={{textDecoration:"none"}}>Dematerialisation</a><br/>
                    <a href=""  className='text-muted py-5' style={{textDecoration:"none"}}>Fund transfer</a ><br/>
                    <a href=""  className='text-muted py-5' style={{textDecoration:"none"}}>MTF</a ><br/>
                    <a href=""  className='text-muted py-5' style={{textDecoration:"none"}}>Referral program</a ><br/>
                    </div>
                </div>
                <div className='col'>
                    <p>Support</p>
